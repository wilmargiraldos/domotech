...
DEFAULT_INVENTORY: list[ProductRecord] = [
    ...
    {
        "id": 11,
        "name": "Relay Module 4 Canales 5V",
        "price": 9.75,
        "cat": "Domotica",
        "stock": 20,
    },
    {
        "id": 12,
        "name": "Relay Module 8 Canales Optoacoplado",
        "price": 16.50,
        "cat": "Domotica",
        "stock": 12,
    },
    ...
    {
        "id": 14,
        "name": "Sonoff Basic R4 WiFi Switch",
        "price": 11.99,
        "cat": "Domotica",
        "stock": 24,
    },
    {
        "id": 15,
        "name": "Zigbee USB Coordinator CC2652P",
        "price": 32.00,
        "cat": "Zigbee",
        "stock": 9,
    },
    ...
    {
        "id": 23,
        "name": "Jumpers Dupont 120 piezas",
        "price": 5.50,
        "cat": "Prototipado",
        "stock": 44,
    },
    ...
    {
        "id": 26,
        "name": "Camara Raspberry Pi Camera Module 3",
        "price": 34.00,
        "cat": "Raspberry Pi",
        "stock": 7,
    },
    ...
    {
        "id": 32,
        "name": "NFC Tags NTAG215 Pack x10",
        "price": 9.90,
        "cat": "Acceso",
        "stock": 21,
    },
    {
        "id": 33,
        "name": "NFC Tags NTAG215 Pack x20",
        "price": 19.80,
        "cat": "Acceso",
        "stock": 11,
    },
...
DEFAULT_PRODUCT_DETAILS: dict[int, dict[str, object]] = {
    1: {
        ...
        "features": [
            "Incluye potencia suficiente para Home Assistant",
            "Ideal para Node-RED, MQTT y paneles web",
        ],
        "specs": {
            "RAM": "8 GB",
            "Uso recomendado": "Servidor domótico local",
    ...
    2: {
        ...
        "features": [
            "Programable con MicroPython o C/C++",
            "Formato pequeño para prototipos embebidos",
        ],
        "specs": {
            "MCU": "RP2040",
    ...
    4: {
        ...
        "specs": {
            ...
            "Conectividad": "WiFi, Bluetooth LE",
        },
    },
    5: {
        ...
        "features": [
            "Doble núcleo",
            "Amplio soporte en Arduino, ESP-IDF y MicroPython",
        ],
        "specs": {
            "MCU": "ESP32",
            "Voltaje lógico": "3.3 V",
    ...
    7: {
        ...
        "features": [
            "Incluye sensores ambientales, luz, sonido y movimiento",
            "Útil para laboratorios de aprendizaje",
        ],
        "specs": {
            "Cantidad": "37 módulos",
            "Nivel": "Principiante a intermedio",
            "Compatibilidad": "Arduino, Raspberry Pi",
        },
    },
    8: {
        "description": "Sensor digital de temperatura y humedad para monitoreo ambiental en interiores.",
        "features": [
            "Lectura digital calibrada",
            "Adecuado para estaciones caseras y domótica",
        ],
        "specs": {
    ...
    11: {
        ...
        "features": [
            ...
            "Apto para automatización de luces y actuadores",
        ],
        "specs": {
            "Canales": "4",
            "Bobina": "5 V",
            "Carga típica": "Hasta 10 A por canal",
        },
    },
    12: {
        "description": "Tarjeta de ocho relés con aislamiento para tableros de pruebas y control múltiple.",
        "features": [
            "Ocho salidas con optoacoplador",
            "Práctico para bancos domóticos",
        ],
    ...
    13: {
        ...
        "features": [
            "Compatible con integración local",
            "Formato mini para instalaciones discretas",
        ],
        "specs": {
            "Carga": "Hasta 8 A",
            "Conectividad": "WiFi, Bluetooth",
            "Uso": "Luces y cargas pequeñas",
        },
    },
    14: {
        "description": "Switch WiFi para controlar dispositivos eléctricos desde plataformas domóticas.",
        "features": [
            "Integrable con firmware alternativo",
            "Apto para encendido remoto",
        ],
        "specs": {
            "Carga": "Hasta 10 A",
            "Conectividad": "WiFi",
    ...
    16: {
        ...
        "features": [
            "Bajo consumo",
            "Útil para seguridad y automatizaciones de entrada",
        ],
        "specs": {
            "Protocolo": "Zigbee",
    ...
    19: {
        ...
        "features": [
            "LEDs direccionables individualmente",
            "Apta para efectos dinámicos",
        ],
    ...
    20: {
        ...
        "features": [
            "Capacidad para cargas demandantes",
            "Útil en instalaciones con LEDs",
        ],
    ...
    21: {
        ...
        "features": [
            "Salida ajustable",
            "Buen recurso para prototipos alimentados por batería",
        ],
    ...
    22: {
        ...
        "features": [
            "Compatible con jumpers Dupont",
            "Zona amplia para circuitos medianos",
        ],
    ...
    23: {
        ...
        "features": [
            "Incluye variaciones macho y hembra",
            "Facilita prototipos rápidos",
        ],
        "specs": {
            "Cantidad": "120 piezas",
            "Tipo": "Dupont",
            "Uso": "Conexiones de prototipo",
        },
    },
    24: {
    ...
    26: {
        ...
        "features": [
            "Integración directa con Raspberry Pi",
            "Útil para timbres, vigilancia y visión artificial",
        ],
        "specs": {
            "Resolución": "12 MP",
            "Interfaz": "CSI",
    ...
    27: {
        ...
        "features": [
            "Reduce cableado en instalaciones fijas",
            "Ideal para nodos de red o cámaras",
        ],
        "specs": {
            "Estándar": "PoE+",
            "Interfaz": "GPIO",
    ...
    29: {
        ...
        "features": [
            "Incluye controlador ULN2003",
            "Adecuado para mecanismos pequeños",
        ],
    ...
    33: {
        ...
        "features": [
            "Mayor cantidad para despliegues de prueba",
            "Compatibles con flujos NFC desde móviles",
        ],
...
class InventoryStore:
    ...
    def load(self) -> list[ProductRecord]:
        if not self.path.exists():
            self._products = [
                self._normalize_product(product) for product in DEFAULT_INVENTORY
            ]
            self.save()
    ...
    def update_product(
        ...
        *,
        ...
        if features is not None:
            product["features"] = [
                feature.strip() for feature in features if feature.strip()
            ]
