...
- ✅ Definición inicial de la UI y estructura base del proyecto.
- ✅ Ajustes menores y corrección de errores tipográficos.
- ✅ Corrección del bug de la barra de estado.
- ✅ Corrección del bug del título.
- ✅ Corrección del comportamiento del filtro.
- ✅ Corrección del contenido de los items del carrito.
...
- 🗑️ Descartado: tarea que se decidió no realizar.

Para marcar el avance de una tarea, reemplaza el icono al inicio de la línea por el estado correspondiente.
...
- 🗑️ [tarea descartada] — motivo del descarte.
